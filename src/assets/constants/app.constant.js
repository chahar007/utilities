...
export const FAQs =  [
    ...
    {
        question: "What formats do you support for images?",
        answer: "We support JPG, PNG, and WebP formats for conversion and optimization.",
    },
    {
        question: "What PDF operations can I perform?",
        answer: "You can merge multiple PDFs, split PDFs into separate pages, compress PDFs, and convert PDFs to images.",
    },
    {
        question: "Is my data secure when using your tools?",
        answer: "Absolutely! All processing happens in your browser - we never upload your files to our servers.",
    },
];
