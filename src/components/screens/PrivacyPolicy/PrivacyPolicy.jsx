        ...
        <div className={classes.PrivacyPolicyPage} >
            <div className={classes.ppcontainer}>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Utilix.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Utilix, accessible from <a href="https://utilix.pro/" rel="external nofollow noopener" target="_blank">https://utilix.pro/</a></p>
                    </li>
                    <li>
