...
// export const LazySudoku = lazy(() => import('./sudoku'));
// export const LazySnakeGame = lazy(() => import('./snake-game'));
// export const LazyBrickBreaker = lazy(() => import('./brick-breaker'));
// export const LazyDinoRun = lazy(() => import('./dino-run'));
// export const LazyFlappyBird = lazy(() => import('./flappy-bird-clone'));
// export const LazySolitaire = lazy(() => import('./solitaire'));
// export const LazyReversi = lazy(() => import('./reversi-othello'));
// export const LazyChess = lazy(() => import('./chess'));
